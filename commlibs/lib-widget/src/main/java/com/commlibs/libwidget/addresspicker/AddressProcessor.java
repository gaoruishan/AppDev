...
import static com.commlibs.libwidget.addresspicker.AddressPickerView.CITY;
import static com.commlibs.libwidget.addresspicker.AddressPickerView.COUNTRY;
import static com.commlibs.libwidget.addresspicker.AddressPickerView.PROVINCE;
	...
	public boolean handleMessage(Message msg) {
		...
		switch (msg.what) {
			case MSG_AREA:
				...
				proviceList.clear();
				List<AddressBean> list1 = gson.fromJson(listStr, new TypeToken<List<AddressBean>>() {
				}.getType());
			...
			case MSG_CITY:
				...
				cityList.clear();
				List<AddressBean> list2 = gson.fromJson(listStr, new TypeToken<List<AddressBean>>() {
				}.getType());
			...
			case MSG_COUNTRY:
				...
				List<AddressBean> list3 = gson.fromJson(listStr, new TypeToken<List<AddressBean>>() {
				}.getType());
